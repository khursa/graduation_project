  ...
  render() {
    return (
      <div className="electro__info">
        <Electro__title electro__title="КАНАЛИ ЗВ'ЯЗКУ"/>
        <Electro__subtitle__web  subtitle__web ="ВОЛЗ ТА ETHERNET"/>
        <Electro__text1 electro__text__1="Прокладання та обслуговування волоконно-оптичних ліній зв'язку"/>
        <Electro__subtitle__print  subtitle__print ="WIMAX"/>
